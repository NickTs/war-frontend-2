...
import {getDictCountries} from "../dict/Dicts"
...
class SelectCountry extends React.Component {
    ...
    componentDidMount() {
        ...
        let suggestionsValue = getDictCountries(lang).map(country => ({
            value: country.key,
            label: country.label,
        }))
        this.setState({
            ...
            <div className={classes.root}>
                <NoSsr>
                    <Select
                        ...
                        placeholder={intl.formatMessage({id: 'SelectCountry.placeholder'})}
                        isClearable
...
export default injectIntl(withStyles(styles, { withTheme: true })(SelectCountry));