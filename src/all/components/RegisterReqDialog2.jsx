...
class RegisterReqDialog2 extends React.Component {
    handleClose = () => {
    ...
    componentDidMount() {
        ...
        this.props.dispatch(change("RegisterReq2Form", "lang", lang));
        this.props.dispatch(focus("RegisterReq2Form", "name"));
    }
    ...
    componentWillReceiveProps(nextProps) {
        if(nextProps.dlgData && nextProps.dlgData.userType){
            if(!this.props.dlgData || !this.props.dlgData.userType || nextProps.dlgData.userType!=this.props.dlgData.userType){
                this.props.dispatch(change("RegisterReq2Form", "userType", nextProps.dlgData.userType));
            }
        }
    }
...
RegisterReqDialog2 = reduxForm({
    form: 'RegisterReq2Form',
    validate
})(RegisterReqDialog2)



export default injectIntl(withStyles(registerDialog2)(RegisterReqDialog2));