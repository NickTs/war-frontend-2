...
import {bottomBarPublic} from "../styles/ThemeDefault";


function BottomBarPublic(props) {
    const {classes} = props;
    return (
...
BottomBarPublic.propTypes = {
    classes: PropTypes.object.isRequired,
    intl: PropTypes.object.isRequired,
};

export default injectIntl(withStyles(bottomBarPublic)(BottomBarPublic));