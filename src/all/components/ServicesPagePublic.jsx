...
class ServicesPagePublic extends React.Component {
            ...
            <div className={classes.root}>
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        width: '100%',
                        textAlign: 'center'
                    }}>В разработке.<br/>Здесь будет располагаться информация предоставляемых сертификатах, документах и т.д..
                    </div>
                </div>
...
ServicesPagePublic.propTypes = {
    classes: PropTypes.object.isRequired,
    intl: PropTypes.object.isRequired
};

export default injectIntl(withStyles(pageDefault)(ServicesPagePublic));