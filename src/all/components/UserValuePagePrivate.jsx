        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'UserValuePagePrivate.PanelResume.title'})}</b></div>
...
class PanelPrevOwners extends React.Component {
    ...
    render() {
        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'UserValuePagePrivate.PanelPrevOwners.title'})}</b></div>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
...
class PanelLinks extends React.Component {
    ...
    render() {
        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'UserValuePagePrivate.PanelLinks.title'})}</b></div>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                    {this.showDataValue(dataValue)}
                </ExpansionPanelDetails>
...
class PanelDocuments extends React.Component {
    state = {
        expansionPanelOpen: false,
    }
    ...
    showDataValue(user, dataValue) {
        if (dataValue.valueId) {
            return (
                <div>
                    <table>
                        <tbody>
                        <tr>
                            <td>
                                <div style={{width: '100%', fontSize: '16px'}}>
                                    <a href={"https://www.worldart.ml/b/documents/5c3f1de3b5d03e60325aaf48/byvalue?docl=en&docuserid=" + user.id + "&docvalueid=" + dataValue.valueId}
                                       target="_blank" style={{color: '#000000'}}>Certificate of authenticity</a>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div style={{width: '100%', fontSize: '16px'}}>
                                    <a href={"https://www.worldart.ml/b/documents/5c3f1de3b5d03e60325aaf48/byvalue?docl=en&docuserid=" + user.id + "&docvalueid=" + dataValue.valueId}
                                       target="_blank" style={{color: '#000000'}}>Certificate of authenticity and
    ...
    render() {
        const {classes, intl, user, dataValue} = this.props;
        let myIcon
        if (this.state.expansionPanelOpen) {
            myIcon = (
                <ExpandMoreIconClose style={{color: '#D6002A'}} onClick={() => {
        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'UserValuePagePrivate.PanelDocuments.title'})}</b></div>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                    {this.showDataValue(user, dataValue)}
                </ExpansionPanelDetails>
            </ExpansionPanel>
        )
    }
...
class UserValuePagePrivate extends React.Component {
    ...
    render() {
        const {classes, intl, goRegister, goLogin, lang, dbValues, user, profile, goEditValue} = this.props;
        ...
        if (dbValues && dbValues.listPicture && dbValues.listPicture.length > 0) {
            ...
            return (
                <div className={classes.root}>
                    <TopBarPrivateFunc visibleHome={true} goRegister={goRegister} goLogin={goLogin} lang={lang}/>
                                    ...
                                    <table style={{width: '100%'}}>
                                        ...
                                        {dbPicture.info[0].description && <tr>
                                            <td style={{fontSize: '18px', paddingTop: '20px', paddingBottom: '10px'}}>
                                                <b>{intl.formatMessage({id: 'UserValuePagePrivate.Description.label'})}</b>
                                            </td>
                                        </tr>}
                                        {dbPicture.info[0].description && <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{
                                                    fontSize: '12px',
                                                    paddingRight: '10px'
                                                }}/> {intl.formatMessage({id: 'UserValuePagePrivate.Category.label'})}: <span
                                                style={{textDecoration: 'underline'}}>{intl.formatMessage({id: 'UserValuePagePrivate.Category.vt.' + dbValue.vt})}</span>
                                            </td>
                                        </tr>
                                        {dbPicture.dateCreate && <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{
                                                    fontSize: '12px',
                                                    paddingRight: '10px'
                                                }}/> {intl.formatMessage({id: 'UserValuePagePrivate.Year.label'})}: <span
                                        ...
                                        {dbPicture.info[0].creationTech && <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{
                                                    fontSize: '12px',
                                                    paddingRight: '10px'
                                                }}/> {intl.formatMessage({id: 'UserValuePagePrivate.Technique.label'})}: <span
                                        ...
                                        {dbPicture.dimension && <tr>
                                            <td style={{whiteSpace: 'nowrap', paddingBottom: '10px'}}><TopicIcon
                                                style={{
                                                    fontSize: '12px',
                                                    paddingRight: '10px'
                                                }}/> {intl.formatMessage({id: 'UserValuePagePrivate.Size.label'})}: {dbPicture.dimension[0].w + ' x ' + dbPicture.dimension[0].h + ' ' + dbPicture.dimension[0].metric}
                                            </td>
                                        </tr>}
                                        ...
                                        <tr>
                                            <td style={{paddingTop: '40px'}}>
                                                <ButtonBorderPrimary onClick={() => goEditValue(lang, dbValues)}>
                                                    <EditIcon style={{paddingRight: 10}}/>
                                                    {intl.formatMessage({id: 'UserValuePagePrivate.btnEditValue.label'})}
                                                </ButtonBorderPrimary>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td style={{paddingTop: '20px'}}><PanelDocuments style={{width: '100%'}}
                                                                                             dataValue={dbPicture}
                                                                                             user={user}
                                                                                             profile={profile}
                                                                                             intl={intl}/></td>
...
UserValuePagePrivate.propTypes = {
    classes: PropTypes.object.isRequired,
    intl: PropTypes.object.isRequired
};

export default injectIntl(withStyles(pageDefault)(UserValuePagePrivate));