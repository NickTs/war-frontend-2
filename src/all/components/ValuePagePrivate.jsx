        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'ValuePagePrivate.PanelResume.title'})}</b></div>
...
class PanelPrevOwners extends React.Component {
    ...
    render() {
        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'ValuePagePrivate.PanelPrevOwners.title'})}</b></div>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
...
class PanelLinks extends React.Component {
    ...
    render() {
        ...
        return (
            <ExpansionPanel expanded={this.state.expansionPanelOpen}>
                <ExpansionPanelSummary expandIcon={myIcon} style={{backgroundColor: '#F7F7F7', fontSize: '18px'}}>
                    <div><b>{intl.formatMessage({id: 'ValuePagePrivate.PanelLinks.title'})}</b></div>
                </ExpansionPanelSummary>
                <ExpansionPanelDetails>
                    {this.showDataValue(dataValue)}
                </ExpansionPanelDetails>
...
class ValuePagePrivate extends React.Component {
                                    ...
                                    <table style={{width: '100%'}}>
                                        ...
                                        {dbPicture.info[0].description && <tr>
                                            <td style={{fontSize: '18px', paddingTop: '20px', paddingBottom: '10px'}}>
                                                <b>{intl.formatMessage({id: 'ValuePagePrivate.Description.label'})}</b></td>
                                        </tr>}
                                        {dbPicture.info[0].description && <tr>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{fontSize: '12px', paddingRight: '10px'}}/> {intl.formatMessage({id: 'ValuePagePrivate.Category.label'})}: <span
                                                style={{textDecoration: 'underline'}}>{intl.formatMessage({id: 'ValuePagePrivate.Category.vt.'+dbValue.vt})}</span></td>
                                        </tr>
                                        {dbPicture.dateCreate && <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{fontSize: '12px', paddingRight: '10px'}}/> {intl.formatMessage({id: 'ValuePagePrivate.Year.label'})}: <span
                                                style={{textDecoration: 'underline'}}>{dbPicture.dateCreate}</span></td>
                                        </tr>}
                                        {dbPicture.info[0].creationTech && <tr>
                                            <td style={{paddingBottom: '10px'}}><TopicIcon
                                                style={{fontSize: '12px', paddingRight: '10px'}}/> {intl.formatMessage({id: 'ValuePagePrivate.Technique.label'})}: <span
                                        ...
                                        {dbPicture.dimension && <tr>
                                            <td style={{whiteSpace: 'nowrap', paddingBottom: '10px'}}><TopicIcon
                                                style={{
                                                    fontSize: '12px',
                                                    paddingRight: '10px'
                                                }}/> {intl.formatMessage({id: 'ValuePagePrivate.Size.label'})}: {dbPicture.dimension[0].w + ' x ' + dbPicture.dimension[0].h + ' ' + dbPicture.dimension[0].metric}
                                            </td>
                                        </tr>}
...
ValuePagePrivate.propTypes = {
    classes: PropTypes.object.isRequired,
    intl: PropTypes.object.isRequired
};

export default injectIntl(withStyles(pageDefault)(ValuePagePrivate));