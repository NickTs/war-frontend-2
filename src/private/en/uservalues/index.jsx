...
import {valueGetAll} from "../../../all/actions/ValueGetAll";
...
function indexStartup(locale, theme, store, history, userSession) {
    axios.get('/private/assets/uservalues/' + locale + '.json')
        .then(result => {
        ...
        .then(() => {
            console.log("goFinished=", userSession)
...
axiosBackendApi.get('auth/int/session?jwt='+jwt, {
    ...
    .then(result => {
        ...
        store.dispatch(valueGetAll(locale, userSession.user, userSession))
