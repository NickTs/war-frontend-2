...
const Root = ({store, history}) => (
    <Provider store={store}>
        <ConnectedRouter history={history}>
            <div>
                <Switch>
                    <Route exact path="/public/ru" render={(props) => {
                    ...
                    <Route exact path="/public/ru/register" component={TmpRegister1PageFunc} />
                    ...
                    <Route exact path="/public/ru/login" component={TmpLoginPageFunc} />
